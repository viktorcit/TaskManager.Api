        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_EmployerProfiles_EmployerId", x => x.EmployerId);
                    table.ForeignKey(
                        name: "FK_EmployerProfiles_AspNetUsers_EmployerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    CanAnyoneJoin = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_EmployerProfiles_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskPerformers_AspNetUsers_PerformerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserName_Email_NormalizedUserName",
                table: "AspNetUsers",
                columns: new[] { "UserName", "Email", "NormalizedUserName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinToTaskRequests_UserId_TaskId",
                table: "JoinToTaskRequests",
                columns: new[] { "UserId", "TaskId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaskPerformers_PerformerId_TaskId",
                table: "TaskPerformers",
                columns: new[] { "PerformerId", "TaskId" },
                unique: true);
